...
val = 5917
def getPath():
    return "/home/vasudhaika/Desktop/Agriculture"
...
def scrape(startingurl,foldername):
...
def main():
    ##Agri
    scrape("http://www.dmoz.org/search?q=agriculture&start="+str(val)+"&type=next&all=null&t=null&cat=","Agriculture")
    #News
    #scrape("http://www.dmoz.org/search?q=news&t=null&all=no&cat=", "News")
